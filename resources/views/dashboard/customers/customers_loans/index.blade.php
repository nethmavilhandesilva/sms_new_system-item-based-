        ...
        $(document).ready(function () {
            ...
            function updateDescription() {
                ...
                if (customerId && (loanType === 'today' || loanType === 'old')) {
                    $.ajax({
                        url: `https://talentconnect.lk/customers/${customerId}/loans-total`,
                        method: 'GET',
            ...
            $('#loanForm').on('submit', function (e) {
                ...
                if (method === 'PUT') {
                    ...
                    url = `https://talentconnect.lk/customers-loans/${loanId}`
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (returnGrn) {
                returnGrn.addEventListener('change', function () {
                    let code = this.value;
                    if (!code) return;
                    fetch(`https://talentconnect.lk/api/grn-entry/${code}`)
                        .then(res => res.json())
                        .then(data => {
            ...
            fetch('https://talentconnect.lk/api/all-bill-nos')
                .then(res => res.json())
                .then(billNosObj => {
